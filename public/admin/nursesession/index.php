            ...
            <div class="card-body" style="padding-top: 1rem; padding-bottom: .9rem;">
                <div class="row page-titles" style="padding-bottom: 0px;">
                    <div class="col-md-6 align-self-center">
                        <h3 class="text-themecolor mb-0 mt-0" style="font-weight: 500">NURSE SESSION LOGS</h3>
                    </div>
                    <div class="col-md-6 align-self-center">
                        <ol class="breadcrumb bredneed float-right">
                            ...
                            <li class="breadcrumb-item"><span style="font-weight: 400">Nurse Session Logs</span></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 colsearchorders">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control searchinputorder" id="txtsearchnurselogs" placeholder="Search Nurse . . .">
                    </div>
                </div>    
        ...
        <div class="col-12">
            <div class="mb-3">
                <table data-height="350" class="table table-bordered fixTable table-hover" style="margin-bottom: 0px;">
                    ...
                    <tbody id="tblnurselogslist"></tbody>
                </table>
            </div>

            <input id="txtnurselogslistPageCount" type="hidden">
            <ul id="upnurselogslistPageList" class="pagination float-right"></ul>
        </div>
    </div>
</div>

<?php 
    include("nursesession/script.php"); 
?>