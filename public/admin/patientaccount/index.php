            ...
            <div class="card-body" style="padding-top: 1rem; padding-bottom: .9rem;">
                <div class="row page-titles" style="padding-bottom: 0px;">
                    <div class="col-md-6 align-self-center">
                        <h3 class="text-themecolor mb-0 mt-0" style="font-weight: 500">PATIENT ACCOUNT</h3>
                    </div>
                    <div class="col-md-6 align-self-center">
                        <ol class="breadcrumb bredneed float-right">
                            ...
                            <li class="breadcrumb-item"><span style="font-weight: 400">Patient Account</span></li>
                        </ol>
                    </div>
                </div>
            </div>
...
<div class="container-fluid" style="padding: 15px 15px; background-color: white; min-height: 540px; margin-top: 15px;">
    <div class="row" style="margin-bottom: .5rem;">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control searchinputorder" id="txtsearchpatient" placeholder="Search Patient . . .">
                    </div>
                </div>    
        ...
        <div class="col-md-4 coldashboardbox4">
            <button class="btn float-right btn-primary btnCpayment buttonpayment" onclick="modaladdpatient();"><i class="fas fa-plus"></i> Patient</button>
        </div>
    </div>
            ...
            <div class="mb-3">
                <table data-height="350" class="table table-bordered fixTable" style="margin-bottom: 0px;">
                    <thead class="bg-success text-white">
                        <tr>
                            <th style="width: 8%;white-space: nowrap;"> Patient ID </th>
                            <th style="width: 15%;white-space: nowrap;"> Patient Name </th>
                    ...
                    <tbody id="tblpatientlist"></tbody>
                </table>
            </div>

            <input id="txtpatientlistPageCount" type="hidden">
            <ul id="uppatientlistPageList" class="pagination float-right"></ul>
        </div>
    </div>
</div>

<?php 
    include("patientaccount/modal.php"); 
    include("patientaccount/script.php"); 
?>
