                ...
                <div class="row page-titles" style="padding-bottom: 0px;">
                    ...
                    <div class="col-md-6 align-self-center">
                        <ol class="breadcrumb bredneed float-right">
                            ...
                            <li class="breadcrumb-item"><span style="font-weight: 400">Appointment History</span></li>
                        </ol>
                    </div>
                </div>
            </div>
...
<div class="container-fluid" style="padding: 15px 15px; background-color: white; min-height: 540px; margin-top: 15px;">
            ...
            <div class="row">
                <div class="col-md-6 colsearchorders">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control searchinputorder" id="txtsearchappointment" placeholder="Search Appointment . . .">
                    </div>
                </div>    
    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-3">
                <table data-height="350" class="table table-bordered fixTable table-hover" style="margin-bottom: 0px;">
                    <thead class="bg-success text-white">
                        <tr>
                            <th style="width: 6%;white-space: nowrap;"> Appointment ID </th>
            ...
            <input id="txtappointmentlistPageCount" type="hidden">
            <ul id="upappointmentlistPageList" class="pagination float-right"></ul>
        </div>
    </div>
</div>

<?php 
    include("appointmenthistory/script.php"); 
    include("appointmenthistory/modal.php");
?>