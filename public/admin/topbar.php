        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                <li class="nav-item dropdown">
                    <a class="nav-link text-muted waves-effect waves-dark" href="#" style="font-weight: 400; font-size: 18px; padding-right: 1px;"><span id=""><b><?php echo $_SESSION['firstname']?></b></span></a>
