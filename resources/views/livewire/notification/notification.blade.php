        ...
        <form>
            ...
            <div class="d-flex flex-column pt-8 bgi-size-cover bgi-no-repeat rounded-top"
                ...
                <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#topbar_notifications_events">Appointment {{ $countApprove }}</a>
                    </li>
                </ul>
                <!--end::Tabs-->
            </div>
                        ...
                        @forelse ($bookApp as $bookApt)
                            ...
                            <a href="{{ route('bookAppointment.index') }}" class="navi-item">
                                <div class="navi-link">
                                    ...
                                    <div class="navi-text">
                                        <div class="font-weight-bold">{{ $bookApt->user->name }} book an appointment</div>
                                        <div class="text-muted">{{ $bookApt->created_at->format('F d, Y') }} | {{ $bookApt->created_at->format('h:i') }}</div>
                                    </div>
                                </div>
                            </a>
                            <!--end::Item-->
                ...
                <div class="tab-pane" id="topbar_notifications_events" role="tabpanel">
                    ...
                    <a href="{{ route('appointment.index') }}" class="navi-item">
                        <div class="navi-link">
                            ...
                            <div class="navi-text">
                                <div class="font-weight-bold">You have an appointment today with {{ $app->user->name }}</div>
                                <div class="text-muted">at {{ $app->appointment_time->format('h:i a') }}</div>
                            </div>
                        </div>
                    </a>
                    <!--end::Item-->
