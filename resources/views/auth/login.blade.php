                ...
                <div class="card-body cardbodylogin" style="padding: 1.25rem 1.8rem;">
                    <div class="form-horizontal form-material">
                        ...
                        <div class="form-group mt-4">
                            <div class="col-xs-12">
                                <button class="btn btn-info btn-md btn-block text-uppercase waves-effect waves-light mb-1" onclick="loginuser();" style="padding: 10px 10px; font-weight: 500">LogIn</button>
                                <span style="font-size: 14px;">Don't have an account yet?<a href="{{ route('register') }}" class="text-info"> Create an Account.</a></span>
                            </div>
                        </div>
                    </div>
                </div>
